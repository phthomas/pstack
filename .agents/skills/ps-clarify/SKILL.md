...
2. For each open item, first reason about it briefly — the realistic options and a recommendation — then ask me to decide. Group questions and present clear options with a recommended default (on Claude Code, use AskUserQuestion for the multiple-choice ones). Don't bury me; batch sensibly.
