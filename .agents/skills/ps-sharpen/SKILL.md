...
2. If it's ready, interview me interactively — one question at a time, most consequential first, targeting the gaps, not what I've already answered. For each, offer your recommended default and the tradeoff so I can confirm or redirect. (On Claude Code, use AskUserQuestion for the structured choices; on agents without it, just ask in plain text.)
