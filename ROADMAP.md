...
| # | Phase | Status | In MVP? | Spec |
|---|-------|--------|---------|------|
| 1 | <name> | planned | yes | specs/01-<name>.md |
| 2 | <name> | planned | yes | specs/02-<name>.md |
| 3 | <name> | planned | yes | specs/03-<name>.md |

Status values: planned · in progress · blocked · done.
MVP = the phases that make the first complete product; the rest are post-MVP.

## Post-MVP / later
<!-- Phases beyond the first complete product. When one graduates into the build, add a row above and a spec file in specs/. -->
-
