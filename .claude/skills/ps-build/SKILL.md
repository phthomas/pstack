...
7. When every criterion passes the gate, offer /ps-review on the phase diff — fresh-context judgment at /ps-review's weight (one combined judge by default; the split panel when the diff earns it), findings to me as must-fix / worth-considering / skip-it. Then set the phase to done in ROADMAP.md and hand off to /ps-close.
