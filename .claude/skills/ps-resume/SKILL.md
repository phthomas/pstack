...
6. Brief me — short, not a file dump: where we are (which phase, what's done, what's failing), what changed last session, any open questions or blockers, and the single most sensible next action. STATE.md is a claim; git and the tests are the facts — if they disagree, say so and trust the facts. Then stop and wait for me to confirm or redirect — don't start building on your own.
